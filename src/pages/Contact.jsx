...
function getEmailHref(formData) {
  ...
  return `${contactDetails.emailHref}?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`
}
      ...
      <section className="contact-intro" aria-labelledby="contact-title">
        <div className="container contact-intro__grid">
          <div className="contact-intro__copy">
            ...
            <p>
              Tell us what is fixed, what is still open, and what the event has to achieve. We will
              shape the rest.
            </p>
            <a href="#brief-heading" className="contact-intro__jump">
              Go to the event brief <FaArrowRight aria-hidden="true" />
            </a>
          </div>

          <address className="contact-channels">
            <span className="contact-channels__location">{contactDetails.location}</span>
            <a href={contactDetails.phoneHref}>
              <FaPhoneAlt aria-hidden="true" />
              <span><small>Call</small>{contactDetails.phone}</span>
            </a>
      ...
      <section className="contact-form-section section-shell" aria-labelledby="brief-heading">
        <div className="container contact-form-layout">
          <AnimatedSection className="contact-form-intro">
            ...
            <p>
              A useful brief is not a finished production plan. Share what you know and the team
              takes the conversation forward from there.
            </p>

            <div className="contact-form-notes" aria-label="What to include">
              <p>Useful to include</p>
              <ul>
                <li>Purpose and who the audience is</li>
                <li>Whether the venue is confirmed</li>
                <li>Budget range, even approximate</li>
                <li>What is already contracted</li>
              </ul>
            </div>
          </AnimatedSection>
