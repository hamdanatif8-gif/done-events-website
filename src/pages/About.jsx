...
import { capabilities, eventFormats, processSteps } from '../content/siteContent'
import './About.css'
        ...
        <div className="container about-model__grid">
          ...
          <div className="about-model__disciplines">
            {capabilities.map((capability, index) => (
              <AnimatedSection key={capability.id} className="about-discipline" delay={index * 0.05}>
                <span className="about-discipline__number">{capability.number}</span>
